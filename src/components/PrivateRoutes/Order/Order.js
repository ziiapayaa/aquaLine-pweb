            ...
            <div className="container mt-5">
                ...
                <div className="col-lg-4 d-none d-lg-block px-3 mt-5">
                    ...
                    <div style={{ border: '1px solid lightgrey' }} className="p-2">
                        <h2 className='fs-5 text-center'>Sub Total : {cart.reduce((a, b) => { return a + (b.quantity); }, 0)} Item</h2>
                        <h3 className='fs-5 text-center'>Price : {cart.reduce((a, b) => a + b.price * b.quantity, 0)}K</h3>
                    </div>
